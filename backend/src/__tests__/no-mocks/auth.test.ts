...
describe('Auth API - No Mocking', () => {
   ...
   */
  test('POST /api/auth/signup - should fail with invalid Google token (no mocking)', async () => {
   ...
   */
  test('POST /api/auth/signup - should return 400 for missing token', async () => {
    const response = await request(app)
      .post('/api/auth/signup')
      .send({});
   ...
   * Expected Behavior: Should return error for missing token
   */
  test('POST /api/auth/login - should return 400 for missing token', async () => {
    const response = await request(app)
      .post('/api/auth/login')
      .send({});
   ...
   * Expected Behavior: Should fail with invalid token error
   */
  test('POST /api/auth/login - should fail with invalid Google token (no mocking)', async () => {
    const response = await request(app)
      .post('/api/auth/login')
      .send({ token: 'invalid-token' });
   ...
   */
  test('POST /api/auth/signup - should return 400 for empty token string', async () => {
    const response = await request(app)
      .post('/api/auth/signup')
      .send({ token: '' });
   ...
   * Expected Behavior: Should return error for empty token string
   */
  test('POST /api/auth/login - should return 400 for empty token string', async () => {
    const response = await request(app)
      .post('/api/auth/login')
      .send({ token: '' });
   ...
   */
  test('POST /api/auth/signup - should successfully signup with valid token', async () => {
    const response = await request(app)
      .post('/api/auth/signup')
   ...
   */
  test('POST /api/auth/login - should successfully login with valid token', async () => {
    // Create user first
   ...
   */
  test('POST /api/auth/signup - should handle null payload from Google token', async () => {
    const response = await request(app)
      .post('/api/auth/signup')
