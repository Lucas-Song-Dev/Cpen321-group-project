...
// @route   GET /api/task
// @access  Private
router.get('/', asyncHandler(taskController.getGroupTasks.bind(taskController)));

// @desc    Get tasks assigned to current user
// @route   GET /api/task/my-tasks
// @access  Private
router.get('/my-tasks', asyncHandler(taskController.getUserTasks.bind(taskController)));

// @desc    Update task status
// @route   PUT /api/task/:id/status
// @access  Private
router.put('/:id/status', asyncHandler(taskController.updateTaskStatus.bind(taskController)));

// @desc    Assign task to users for current week
// @route   POST /api/task/:id/assign
// @access  Private
router.post('/:id/assign', asyncHandler(taskController.assignTask.bind(taskController)));

// @desc    Algorithmically assign all tasks for current week
// @route   POST /api/task/assign-weekly
// @access  Private
router.post('/assign-weekly', asyncHandler(taskController.assignWeeklyTasks.bind(taskController)));

// @desc    Get tasks for a specific week
// @route   GET /api/task/week/:weekStart
// @access  Private
router.get('/week/:weekStart', asyncHandler(taskController.getTasksForWeek.bind(taskController)));

// @desc    Get tasks for a specific date
// @route   GET /api/task/date/:date
// @access  Private
router.get('/date/:date', asyncHandler(taskController.getTasksForDate.bind(taskController)));

// @desc    Delete task
// @route   DELETE /api/task/:id
// @access  Private
router.delete('/:id', asyncHandler(taskController.deleteTask.bind(taskController)));
