...
| **GET /api/user/**                 | [`backend/src/__tests__/no-mocks/user.test.ts#L22`](backend/src/__tests__/no-mocks/user.test.ts#L22)           | _Not Implemented_                | User DB, Group DB, Message DB |
| **PUT /api/user/users/profile**    | [`backend/src/__tests__/no-mocks/user.test.ts#L22`](backend/src/__tests__/no-mocks/user.test.ts#L22)           | [`backend/src/__tests__/with-mocks/user.mocks.test.ts#L56`](backend/src/__tests__/with-mocks/user.mocks.test.ts#L56) | User DB |
| **PUT /api/user/users/optionalProfile** | [`backend/src/__tests__/no-mocks/user.test.ts#L22`](backend/src/__tests__/no-mocks/user.test.ts#L22)        | [`backend/src/__tests__/with-mocks/user.mocks.test.ts#L161`](backend/src/__tests__/with-mocks/user.mocks.test.ts#L161) | User DB |
| **DELETE /api/user/users/me**      | [`backend/src/__tests__/no-mocks/user.test.ts#L22`](backend/src/__tests__/no-mocks/user.test.ts#L22)           | [`backend/src/__tests__/with-mocks/user.mocks.test.ts#L233`](backend/src/__tests__/with-mocks/user.mocks.test.ts#L233) | User DB, Group DB |
| **PUT /api/user/users/report**     | [`backend/src/__tests__/no-mocks/user.test.ts#L22`](backend/src/__tests__/no-mocks/user.test.ts#L22)           | [`backend/src/__tests__/with-mocks/user.mocks.test.ts#L474`](backend/src/__tests__/with-mocks/user.mocks.test.ts#L474) | User DB, Group DB, Message DB |
...
| **GET /api/task/my-tasks**         | [`backend/src/__tests__/no-mocks/task.test.ts#L22`](backend/src/__tests__/no-mocks/task.test.ts#L22)           | [`backend/src/__tests__/with-mocks/task.mocks.test.ts#L490`](backend/src/__tests__/with-mocks/task.mocks.test.ts#L490) | Task DB, Group DB |
...
| **GET /api/task/week/:weekStart**  | [`backend/src/__tests__/no-mocks/task.test.ts#L22`](backend/src/__tests__/no-mocks/task.test.ts#L22)           | [`backend/src/__tests__/with-mocks/task.mocks.test.ts#L554`](backend/src/__tests__/with-mocks/task.mocks.test.ts#L554) | Task DB, Group DB |
| **GET /api/task/date/:date**       | [`backend/src/__tests__/no-mocks/task.test.ts#L22`](backend/src/__tests__/no-mocks/task.test.ts#L22)           | [`backend/src/__tests__/with-mocks/task.mocks.test.ts#L626`](backend/src/__tests__/with-mocks/task.mocks.test.ts#L626) | Task DB, Group DB |
...
| **DELETE /api/chat/:groupId/message/:messageId** | [`backend/src/__tests__/no-mocks/chat.test.ts#L38`](backend/src/__tests__/no-mocks/chat.test.ts#L38)   | [`backend/src/__tests__/with-mocks/chat.mocks.test.ts#L489`](backend/src/__tests__/with-mocks/chat.mocks.test.ts#L489) | Message DB, Group DB |
...
| **AuthService**                    | [`backend/src/__tests__/no-mocks/services.test.ts#L10`](backend/src/__tests__/no-mocks/services.test.ts#L10)   | [`backend/src/__tests__/with-mocks/services.mocks.test.ts#L42`](backend/src/__tests__/with-mocks/services.mocks.test.ts#L42) | User DB, JWT Token |
